...
import 'package:studyivs/Result/resulttype.dart';
...
class ShowFields extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: Firestore.instance.collection("Result").snapshots(),
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child: new RaisedButton(onPressed:
                                          (){
                                        Navigator.push(context,new MaterialPageRoute(builder: (context) => new ResultType(fieldname: fieldname)));
                                      },
                                        elevation: 10,
