...
class ShowStudentUploaded extends StatefulWidget {
  String email;
  ShowStudentUploaded({this.email});
  @override
...
class _ShowFetchedState extends State<ShowFetched> {
  ...
  Widget build(BuildContext context) {
          ...
          child: AlertDialog(
            ...
            actions: <Widget>[
              RaisedButton(onPressed: ()async{
                ...
                Firestore.instance.collection("Posts").document(random)
                    .delete()
                    .then((onvalue){
                });
                Firestore.instance.collection("Profilestudyic").document("Profilestudyic").collection(email).document(random)
                    .delete()
                    .then((onvalue){
    ...
    return StreamBuilder(
        stream: Firestore.instance.collection("Profilestudyic").document("Profilestudyic").collection(email).snapshots(),
