...
String sharepoststr="sharepoststr";
...
class _TeacherSocialMediaState extends State<TeacherSocialMedia> {
  ...
  File _image = min.toString() as File;
  ...
  getteachername(){
    FirebaseFirestore.instance.collection("Teacher").document(teacherid).get()
        .then((DocumentSnapshot snapshot){
      if(snapshot.exists){
        teachername = snapshot['name'];
        print("this is the teacher name $teachername");
        print("this is the teacher id $teacherid");
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    print("this is teacher id in scmd $teacherid");
    return Scaffold(
      appBar: AppBar(
  ...
  share(String teacherid)async{
    ...
    if(sharepoststr!=null){
      ...
      await FirebaseFirestore.instance.collection("Profilestudyic").document("Profilestudyic").collection(teacherid).document(randomName)
          .setData({
        'image_url': sharepoststr,
        'caption': "",
        'name': teachername,
