        ...
        child: Column(
          ...
          children: <Widget>[
            ExpansionTile(
              ...
              title: Text("Account Issue",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
              children: <Widget>[
                ExpansionTile(
                  leading: Icon(Icons.info_outline),
                  title: Text("How to create class ?",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
                  children: <Widget>[
                    SizedBox(width: MediaQuery.of(context).size.width*0.9,
                    child: Text('When a teacher will login they will get a navigation bar on the upper left side, first click on that then there will be a option named as your routine click on that and click on the day on which you want to create class and fill up all the details and then click submit then click on view classes you can see all the classes for that day on the page',style: TextStyle(fontSize: 16.0),
                        ),
                    )
                  ],
                )
            ...
            ExpansionTile(
              leading: Icon(Icons.info_outline),
              title: Text("What is class routine page is for ?",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
              children: <Widget>[
                SizedBox(
                  width: MediaQuery.of(context).size.width*0.9,
                  child:Text("In this page you are getting all the classes on the basis of the day ..if today is monday then there is all the classes for monday",style: TextStyle(fontSize: 16.0),),
                )
              ],
            ),
            ExpansionTile(
              leading: Icon(Icons.info_outline),
              title: Text("How can I delete my post from  studyic media ?",style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
              children: <Widget>[
                SizedBox(
                  width: MediaQuery.of(context).size.width*0.9,
